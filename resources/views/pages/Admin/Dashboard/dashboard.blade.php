...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header"> <h3 class="text-info">WELCOME {{auth()->user()->name}}</h3></div>
                ...
                <div class="card-body">
                        ...
                        <h5 class = "text-danger"> PLEASE READ THROUGH THE INSTRUCTIONS BELOW TO UNDERSTAND 
                            ...
                            <ul class="list-group">
                                ...
                                <li class = "list-group-item"> Always Make Sure You Logout From Your Dashboard Before Leaving The Site, For Security Reasons</li>
                            </ul>
                            </div>
