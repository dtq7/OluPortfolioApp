...
@section('content')
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      ...
      <p>I'm <span class="typed" data-typed-items="Civil Engineer, Structural Designer, Freelancer, Photographer"></span></p>
    </div>
  </section><!-- End Hero -->
              ...
              <div class="col-lg-6">
               <ul>
                ...
                @foreach ($abouts as $about )
                   <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 2 November</li>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">Structural Design<i class="val">90%</i></span>
            ...
            <div class="progress">
              <span class="skill">Engineering Drawwing<i class="val">90%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">Electrical<i class="val">80%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            {{-- {{$portfolios}} --}}
              @foreach ($portfolios as $portfolio )
                ...
                <img src = "{{asset('storage/portfolio_images/'.$portfolio->portfolio_images)}}">
